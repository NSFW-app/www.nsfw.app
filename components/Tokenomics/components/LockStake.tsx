          ...
          >
            ...
            <Flex column css={{ gap: '35px' }}>
              ...
              <Text type='body2' subText>
                ...
                within the NSFW ecosystem. As a staker, you are free to enter
                and exit the share of the reward pool but for that privilege the
                yield will be proportionally lower than that of lockers.
              </Text>
              <Text type='body2' subText>
                Staked tokens will be transferable and will unlock access to
                DeFi products that will allow leverage on their positions.
              </Text>
            </Flex>
